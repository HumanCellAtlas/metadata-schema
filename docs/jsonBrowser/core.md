...
content_description | General description of the contents of the file. | string | no |  | Content description | protocol, sample annotation, gene expression matrix, count matrix, sequence alignment, quality control metrics | protocol; gene expression matrix
