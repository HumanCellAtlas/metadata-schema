...
content_description | General description of the contents of the file. | string | yes |  | Content description | protocol, expression matrix, count matrix, quality control metrics, log, gene list, read alignment | protocol; expression matrix
