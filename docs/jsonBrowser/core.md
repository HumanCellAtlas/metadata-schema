...
content_description | General description of the contents of the file. | string | yes |  | Content description | protocol, sample information, expression matrix, count matrix, quality control metrics, log, gene list, read alignment | protocol; expression matrix
