...
is_disease_adjacent | Was the tissue specimen collected from a site adjacent to a disease site (e.g. tumor adjacent)? | boolean | no |  | Disease adjacent |  | yes; no
associated_diseases | Short description of the disease adjacent to the specimen. | array | no | [See module  disease_ontology](module.md#disease-ontology) | Associated disease |  | 
