...
provenance | Provenance information provided by the system. | object | no | [See   provenance](.md/#provenance) |  |  | 
protocol_core | Core protocol-level information. | object | yes | [See core  protocol_core](core.md/#protocol_core) |  |  | 
embedding_conditions | Description of embedding conditions and buffers. | string | no |  | Embedding conditions |  | 4% (vol/vol) of 19:1 acrylamide/bis-acrylamide (BioRad), 60 mM Tris⋅HCl pH 8 (Thermo Fisher Scientific), 0.3 M NaCl (Thermo Fisher Scientific), 0.2% (vol/vol) Tetramethylethylenediamine (TEMED) (Sigma)
fiducial_marker | Fiducial markers (generally beads) for the alignment of images taken across multiple rounds of imaging. | string | no |  | Fiducial marker |  | 0.1-µm-diameter carboxylate-modified orange fluorescent beads (2% solids, Life Technologies), 1:25,000 dilution
exposure_time | Exposure time - as a floating point number - in seconds. | number | no |  | Exposure time |  | 
microscope_setup_description | Description of the microscope setup including manufacturer and model information about the stand, camera and objective. | string | no |  | Description of the microscope setup |  | sCMOS camera (Zyla 4.2; Andor) in combination with a high numerical aperture (NA = 1.3) and objective (UPLSAPO 60 × S2; Olympus)
objective | Objective used for imaging. | string | no |  | Objective |  | 60×) silicone oil objective
protocol_type | The type of protocol. Must be a child term of https://www.ebi.ac.uk/ols/ontologies/efo/terms?iri=http%3A%2F%2Fpurl.obolibrary.org%2Fobo%2FOBI_0000272. | object | yes | [See module  process_type_ontology](module.md/#process_type_ontology) | Protocol type |  | 
