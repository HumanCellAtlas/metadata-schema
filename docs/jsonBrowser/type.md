...
timestamp_stop_utc | Terminal stop time of the full pipeline. | string | yes |  | Stop timestamp |  | 
schema_type | The type of the metadata schema entity. | string | yes |  |  | process | 
...
timestamp_start_utc | Initial start time of the full pipeline. | string | yes |  | Start timestamp |  | 
