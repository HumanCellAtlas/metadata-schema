...
number_of_fields | The number of x y fields in one z plane of the image. | integer | no |  | Number of XY fields |  | 9
y_field_size | The pixel size in the y dimension for a single field of view (tile). | integer | no |  | Y field size |  | 500
x_field_size | The pixel size in the x dimension for a single field of view (tile). | integer | no |  | X field size |  | 500
number_of_focal_planes | The number of focal planes in the z stack in the image. | integer | no |  | Number of Z focal planes |  | 20
total_field_microns | Microns covered by a field in x, y, and z. Z includes all focal planes in a single file. | integer | no |  | Total field microns |  | 20
overlapping_fields_of_view | Are fileds of view (tiles) overlapping in the image? | integer | no |  | Overlapping fields of view? | yes, no | yes
imaging_channel | Information about the imaging channels in the image. | object | no | [See module  imaging_channel](module.md/#imaging_channel) |  |  | 
