...
fiducial_marker | Fiducial markers for the alignment of images taken across multiple rounds of imaging. | object | no | [See module  purchased_reagents](module.md/#purchased_reagents) | Fiducial marker |  | 
