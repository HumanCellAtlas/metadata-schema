...
_Information about the preparation protocol of the biomaterial (slice of tissue or cell suspension) used in an imaging experiment_
...
provenance | Provenance information provided by the system. | object | no | [See   provenance](.md/#provenance) |  |  | 
protocol_core | Core protocol-level information. | object | yes | [See core  protocol_core](core.md/#protocol_core) |  |  | 
fresh_slicing_method | Fresh slicing method used: i.e tissue chopper or vibratome | string | no |  | Fresh slicing method |  | vibratome
fresh_slice_thickness | Fresh slice thickness | string | no |  | Fresh slice thickness |  | 3
final_slice_thickness_unit | The unit in which final slice thickness is expressed. | object | no | [See module  length_unit_ontology](module.md/#length_unit_ontology) | Final slice thickness unit |  | micrometer
final_slicing_method | Final slicing method used: i.e cryosectioning | string | no |  | Final slicing method |  | vibratome
post_resection_interval | Length of time between surgical resection and fresh slicing of tissue | string | no |  | Time between resection and fresh slicing |  | 5
...
pre_final_slice_preservation_method | Tissue preservation method used prior to final slicing | object | no | [See module  preservation_storage](module.md/#preservation_storage) | Pre-final slice preservation method |  | 
fixation_buffer | The buffer used to fix cells. | string | no |  | Fixation buffer |  | 4% PFA in 1XPBS
fixation_temperature | The buffer temperature used for fixation in degrees celsius. | string | no |  | Fixation temperature |  | 4
fixation_time | Time in fixing buffer. | string | no |  | Fixation time |  | 15
fixation_time_unit | Unit in fixing time is expressed. | object | no | [See module  time_unit_ontology](module.md/#time_unit_ontology) | Fixation time |  | hour
dehydration_buffer | Dehydration buffer, such as methanol, ethanol or isopropanol. | string | no |  | Dehydration buffer |  | methanol
clearing_method | Clearing method, if performed, such as active, passive, SDS treatment, RI matching, etc. | string | no |  | Clearing method |  | active
post_final_slicing_interval | Days between secondary slicing and hybridization. | string | no |  | Post final slicing interval |  | 7
