...
organs | A list of organs that were studied in this project. | array | no | [See module  organ_ontology](module.md/#organ_ontology) | Organ(s) |  | 
organ_parts | A list of organ parts that were studied in this project. | array | no | [See module  organ_part_ontology](module.md/#organ_part_ontology) | Organ part(s) |  | 
assays | A list of library preparation assays that were used in this project. | array | no | [See module  process_type_ontology](module.md/#process_type_ontology) | Library preparation assay(s) |  | 
