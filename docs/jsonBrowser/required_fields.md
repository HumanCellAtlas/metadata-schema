...
content_description | General description of the contents of the file. | string |  | Content description | protocol, sample image, expression matrix, count matrix, quality control metrics, log, gene list | sample image; expression matrix
