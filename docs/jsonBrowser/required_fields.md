...
Property name | Description | Type | Object reference? | User friendly name | Allowed values | Example 
--- | --- | --- | --- | --- | --- | --- 
required_brain_specific_field | This is a general brain-specific field that was considered required by brain experts. | string |  | Brain-specific field |  | Cool brain feature
...
Property name | Description | Type | Object reference? | User friendly name | Allowed values | Example 
--- | --- | --- | --- | --- | --- | --- 
text | The specific structure of the human brain. | string |  |  |  | 
