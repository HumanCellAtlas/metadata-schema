...
PFT_age | Indicate the age of the subject at the time point of pulmonary function parameter assessment in years, if known. | number | no |  | Age at Pulmonary Function Test |  | 10; 34; 68
...
test_results | Results from medical tests performed on the individual (free text). | string | no |  | Test results |  | lipid panel shows normal level of LDL (124 mg/dL); HIV, HBV, HCV: Negative
