...
Property name | Description | Type | Required? | Object reference? | User friendly name | Allowed values | Example 
--- | --- | --- | --- | --- | --- | --- | --- 
license_url | URL of the license under which this data is available | string | no |  | License URL |  | https://creativecommons.org/licenses/by/4.0/
license_description | Description of the license under which this dataset is made available | string | no |  | License description |  | Each dataset in this Preview Data Release is licensed under a Creative Commons Attribution 4.0 International License. This is the license for these preview datasets and the license for other HCA data in the future may differ.
license_icon_url | URL of the icon associated with this license | string | no |  | License icon URL |  | https://preview.data.humancellatlas.org/images/icon/icon-cc-by@1x.png
