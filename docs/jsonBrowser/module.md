...
## imaging_channel<a name='imaging_channel'></a>
_Information a single microscope channel. Not required if codebook is used._

Location: module/process/imaging_channel.json

Property name | Description | Type | Required? | Object reference? | User friendly name | Allowed values | Example 
--- | --- | --- | --- | --- | --- | --- | --- 
channel_name | An identifier used for this channel within the experiment. This should align with the way channels are referenced in file_names or file manifests. | string | no |  | Channel name |  | red channel or channel 1
probe | The probe used for target detection. | object | no | [See module  purchased_reagents](module.md/#purchased_reagents) | Probe |  | 
target_molecule | The molecule targeted by the probe in this channel. | array | no | [See module  biological_macromolecule_ontology](module.md/#biological_macromolecule_ontology) | Target molecule |  | 
target_structure | The structure targeted by the probe in this channel. | array | no | [See module  cell_structure_ontology](module.md/#cell_structure_ontology) | Target |  | 
