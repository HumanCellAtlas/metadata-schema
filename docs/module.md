...
publication_title | The full title of the publication. | string | no | Publication title | 
...
$schema | The URL reference to the schema. | string | yes |  | 
schema_version | The version number of the schema in major.minor.patch format. | string | no |  | 4.6.1
storage_method | The method by which a biomaterial was stored. | string | no | Storage method | 
storage_time | Length of time the biomaterial was stored for in Storage time units. | number | no | Storage time | 5
storage_time_unit | The unit in which Storage time is expressed. |  | no | Storage time unit | days
preservation_method | The method by which a biomaterial was preserved or not. | string | no | Storage method | 
...
nutritional_state | Should be one of normal, fasting, or feeding tube removed. |  | no | Nutritional state | 
...
$schema | The URL reference to the schema. | string | yes |  | 
schema_version | The version number of the schema in major.minor.patch format. | string | no |  | 4.6.1
autolysis_score | State of tissue breakdown due to self-digestion. Must be one of: none, mild, moderate. | string | no | Autolysis score | 
...
ischemic_temperature | Whether warm or cold ischemia. | string | no | Ischemic temperature | 
...
quality | Note on how good cell looks if imaged in well before sequencing. | string | no | Cell quality | 
...
$schema | The URL reference to the schema. | string | yes |  | 
schema_version | The version number of the schema in major.minor.patch format. | string | no |  | 4.6.1
barcode_read | The read that the barcode is found in. Should be one of Read 1, Read 2, i7 Index, or i5 Index. | string | yes | Barcode-containing read | 
