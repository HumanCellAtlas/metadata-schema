...
project_core | Core project-level information. | object | no | [See module project_core](module.md/#project_core) |  |  | 
...
biomaterial_core | Core biomaterial-level information. | object | yes | [See module biomaterial_core](module.md/#biomaterial_core) |  |  | 
...
process_core | Core process-level information. | object | yes | [See module process_core](module.md/#process_core) |  |  | 
...
input_molecule | Specific type of nucleic acid molecule from which a sequencing library was prepared. Should be a child term of https://www.ebi.ac.uk/ols/ontologies/efo/terms?iri=http%3A%2F%2Fwww.ebi.ac.uk%2Fefo%2FEFO_0004446. | object | yes | [See module biological_macromolecule_ontology](module.md/#biological_macromolecule_ontology) | Input molecule |  | 
...
schema_version | The version number of the schema in major.minor.patch format. | string | no |  |  |  | 4.6.1
schema_type | The type of the metadata schema entity. | string | yes |  |  | process | 
process_core | Core process-level information. | object | no | [See module process_core](module.md/#process_core) |  |  | 
...
inputs | Input parameters used in the pipeline run, these can be files or string values (settings). | array | yes | [See module parameter](module.md/#parameter) |  |  | 
reference_bundle | Bundle containing the reference used in running the pipeline. | string | yes |  |  |  | 
tasks | Descriptions of tasks in the workflow. | array | yes | [See module task](module.md/#task) |  |  | 
...
outputs | Output generated by the pipeline run. | array | yes | [See module file](module.md/#file) |  |  | 
...
protocol_core | Core protocol-level information. | object | yes | [See module protocol_core](module.md/#protocol_core) |  |  | 
...
file_core | Core file-level information. | object | yes | [See module file_core](module.md/#file_core) |  |  | 
